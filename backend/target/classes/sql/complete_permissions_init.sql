...
-- 清理现有权限数据（可选）
-- DELETE FROM sys_role_permission WHERE customer_id = 'demo';
...
SELECT 
    CONCAT('rp_admin_', LPAD(@row := @row + 1, 3, '0')) as id,
    'role001' as role_id,
    id as permission_id,
    NOW() as create_time,
    'demo' as customer_id
FROM sys_permission, (SELECT @row := 0) r
...
-- 用户管理基础权限
('rp_user_001', 'role002', 'perm001', NOW(), 'demo'),
('rp_user_002', 'role002', 'perm002', NOW(), 'demo'),
('rp_user_003', 'role002', 'perm003', NOW(), 'demo'),
-- 教室管理基础权限
('rp_user_022', 'role002', 'perm022', NOW(), 'demo'),
('rp_user_023', 'role002', 'perm023', NOW(), 'demo'),
('rp_user_024', 'role002', 'perm024', NOW(), 'demo'),
('rp_user_028', 'role002', 'perm028', NOW(), 'demo'),
('rp_user_029', 'role002', 'perm029', NOW(), 'demo'),
-- 预订管理基础权限
('rp_user_031', 'role002', 'perm031', NOW(), 'demo'),
('rp_user_032', 'role002', 'perm032', NOW(), 'demo'),
('rp_user_033', 'role002', 'perm033', NOW(), 'demo'),
('rp_user_034', 'role002', 'perm034', NOW(), 'demo'),
('rp_user_036', 'role002', 'perm036', NOW(), 'demo'),
-- 报表查看权限
('rp_user_043', 'role002', 'perm043', NOW(), 'demo'),
-- 文件上传权限
('rp_user_046', 'role002', 'perm046', NOW(), 'demo'),
-- 组织查看权限
('rp_user_078', 'role002', 'perm078', NOW(), 'demo'),
-- 职位查看权限
('rp_user_073', 'role002', 'perm073', NOW(), 'demo'),
-- 职称查看权限
('rp_user_068', 'role002', 'perm068', NOW(), 'demo');

-- 部门管理员角色权限（扩展权限）
DELETE FROM sys_role_permission WHERE role_id = 'role003';
INSERT INTO sys_role_permission (id, role_id, permission_id, create_time, customer_id) VALUES
-- 用户管理权限（除删除外）
('rp_dept_001', 'role003', 'perm001', NOW(), 'demo'),
('rp_dept_002', 'role003', 'perm002', NOW(), 'demo'),
('rp_dept_003', 'role003', 'perm003', NOW(), 'demo'),
('rp_dept_004', 'role003', 'perm004', NOW(), 'demo'),
('rp_dept_005', 'role003', 'perm005', NOW(), 'demo'),
('rp_dept_007', 'role003', 'perm007', NOW(), 'demo'),
('rp_dept_008', 'role003', 'perm008', NOW(), 'demo'),
-- 教室管理全部权限
('rp_dept_022', 'role003', 'perm022', NOW(), 'demo'),
('rp_dept_023', 'role003', 'perm023', NOW(), 'demo'),
('rp_dept_024', 'role003', 'perm024', NOW(), 'demo'),
('rp_dept_025', 'role003', 'perm025', NOW(), 'demo'),
('rp_dept_026', 'role003', 'perm026', NOW(), 'demo'),
('rp_dept_027', 'role003', 'perm027', NOW(), 'demo'),
('rp_dept_028', 'role003', 'perm028', NOW(), 'demo'),
('rp_dept_029', 'role003', 'perm029', NOW(), 'demo'),
('rp_dept_030', 'role003', 'perm030', NOW(), 'demo'),
-- 预订管理全部权限
('rp_dept_031', 'role003', 'perm031', NOW(), 'demo'),
('rp_dept_032', 'role003', 'perm032', NOW(), 'demo'),
('rp_dept_033', 'role003', 'perm033', NOW(), 'demo'),
('rp_dept_034', 'role003', 'perm034', NOW(), 'demo'),
('rp_dept_035', 'role003', 'perm035', NOW(), 'demo'),
('rp_dept_036', 'role003', 'perm036', NOW(), 'demo'),
('rp_dept_037', 'role003', 'perm037', NOW(), 'demo'),
('rp_dept_038', 'role003', 'perm038', NOW(), 'demo'),
-- 报表权限
('rp_dept_043', 'role003', 'perm043', NOW(), 'demo'),
('rp_dept_044', 'role003', 'perm044', NOW(), 'demo'),
-- 文件管理权限
('rp_dept_045', 'role003', 'perm045', NOW(), 'demo'),
('rp_dept_046', 'role003', 'perm046', NOW(), 'demo'),
-- 区域管理权限
('rp_dept_060', 'role003', 'perm060', NOW(), 'demo'),
('rp_dept_061', 'role003', 'perm061', NOW(), 'demo'),
('rp_dept_062', 'role003', 'perm062', NOW(), 'demo'),
('rp_dept_063', 'role003', 'perm063', NOW(), 'demo'),
('rp_dept_064', 'role003', 'perm064', NOW(), 'demo'),
-- 组织管理权限
('rp_dept_077', 'role003', 'perm077', NOW(), 'demo'),
('rp_dept_078', 'role003', 'perm078', NOW(), 'demo'),
('rp_dept_079', 'role003', 'perm079', NOW(), 'demo'),
('rp_dept_080', 'role003', 'perm080', NOW(), 'demo'),
('rp_dept_081', 'role003', 'perm081', NOW(), 'demo'),
-- 职位管理权限
('rp_dept_072', 'role003', 'perm072', NOW(), 'demo'),
('rp_dept_073', 'role003', 'perm073', NOW(), 'demo'),
('rp_dept_074', 'role003', 'perm074', NOW(), 'demo'),
('rp_dept_075', 'role003', 'perm075', NOW(), 'demo'),
('rp_dept_076', 'role003', 'perm076', NOW(), 'demo'),
-- 职称管理权限
('rp_dept_067', 'role003', 'perm067', NOW(), 'demo'),
('rp_dept_068', 'role003', 'perm068', NOW(), 'demo'),
('rp_dept_069', 'role003', 'perm069', NOW(), 'demo'),
('rp_dept_070', 'role003', 'perm070', NOW(), 'demo'),
('rp_dept_071', 'role003', 'perm071', NOW(), 'demo');

-- ==================== 验证查询 ====================

-- 统计权限总数
SELECT COUNT(*) as total_permissions FROM sys_permission WHERE deleted = 0 AND customer_id = 'demo';
